...
define i32 @__ssl3_cbc_digest_record(i8* %__v1_md_state, i8* %__v2_mac_out, i8* %__v3_hmac_pad, i64 %__v4_md_size, i64 %__v5_md_block_size, i64 %__v6_log_md_block_size, i64 %__v7_sslv3_pad_length, i64 %__v8_md_length_size, i1 %__v9_length_is_big_endian, i32 %__v10_sha_type, i8* %__v11_header, i64 %__v20_header_length, i8* %__v12_data, i64 %__v58___v12_data_len, i64 %__v13_data_plus_mac_size, i8* %__v14_mac_secret, i64 %__v59___v14_mac_secret_len, i1 %__v15_is_sslv3) {
entry:
  %__rval = alloca i32
  ...
  %__v22_length = add i64 %__v58___v12_data_len, %__v20_header_length
...
; <label>:19:                                     ; preds = %16
  ...
  %23 = icmp ugt i64 %__v59___v14_mac_secret_len, 128
...
; <label>:28:                                     ; preds = %27
  ...
  call void @"__memcpy[8]/secret"(i8* %29, i8* %__v14_mac_secret, i64 %__v59___v14_mac_secret_len)
  br label %30
...
; <label>:40:                                     ; preds = %25
  %__v62_lexpr = sub i64 %__v8_md_length_size, 4
  %41 = getelementptr i8, i8* %__v34_length_bytes, i64 %__v62_lexpr
  %42 = load i64, i64* %__v32_bits
  %43 = lshr i64 %42, 24
  %44 = trunc i64 %43 to i8
  store i8 %44, i8* %41
  %__v63_lexpr = sub i64 %__v8_md_length_size, 3
  %45 = getelementptr i8, i8* %__v34_length_bytes, i64 %__v63_lexpr
  %46 = load i64, i64* %__v32_bits
  %47 = lshr i64 %46, 16
  %48 = trunc i64 %47 to i8
  store i8 %48, i8* %45
  %__v64_lexpr = sub i64 %__v8_md_length_size, 2
  %49 = getelementptr i8, i8* %__v34_length_bytes, i64 %__v64_lexpr
  %50 = load i64, i64* %__v32_bits
  %51 = lshr i64 %50, 8
  %52 = trunc i64 %51 to i8
  store i8 %52, i8* %49
  %__v65_lexpr = sub i64 %__v8_md_length_size, 1
  %53 = getelementptr i8, i8* %__v34_length_bytes, i64 %__v65_lexpr
...
; <label>:56:                                     ; preds = %25
  %__v66_lexpr = sub i64 %__v8_md_length_size, 5
  %57 = getelementptr i8, i8* %__v34_length_bytes, i64 %__v66_lexpr
  %58 = load i64, i64* %__v32_bits
  %59 = lshr i64 %58, 24
  %60 = trunc i64 %59 to i8
  store i8 %60, i8* %57
  %__v67_lexpr = sub i64 %__v8_md_length_size, 6
  %61 = getelementptr i8, i8* %__v34_length_bytes, i64 %__v67_lexpr
  %62 = load i64, i64* %__v32_bits
  %63 = lshr i64 %62, 16
  %64 = trunc i64 %63 to i8
  store i8 %64, i8* %61
  %__v68_lexpr = sub i64 %__v8_md_length_size, 7
  %65 = getelementptr i8, i8* %__v34_length_bytes, i64 %__v68_lexpr
  %66 = load i64, i64* %__v32_bits
  %67 = lshr i64 %66, 8
  %68 = trunc i64 %67 to i8
  store i8 %68, i8* %65
  %__v69_lexpr = sub i64 %__v8_md_length_size, 8
  %69 = getelementptr i8, i8* %__v34_length_bytes, i64 %__v69_lexpr
...
; <label>:84:                                     ; preds = %75
  ...
  %__v39_cpylen = sub i64 %__v5_md_block_size, 13
  %87 = getelementptr i8, i8* %__v31_first_block, i64 13
  %88 = getelementptr i8, i8* %__v12_data, i64 0
  call void @"__memcpy[8]/secret"(i8* %87, i8* %88, i64 %__v39_cpylen)
...
; <label>:103:                                    ; preds = %101
  ...
  %__v70_lexpr = sub i64 %104, %__v35_overhang
  %105 = getelementptr i8, i8* %__v12_data, i64 %__v70_lexpr
...
; <label>:109:                                    ; preds = %114, %84
  %__v40_i = phi i64 [ 1, %84 ], [ %115, %114 ]
  %110 = icmp ult i64 %__v40_i, %90
  br i1 %110, label %111, label %116

; <label>:111:                                    ; preds = %109
  %112 = mul i64 %__v5_md_block_size, %__v40_i
  %__v71_lexpr = sub i64 %112, 13
  %113 = getelementptr i8, i8* %__v12_data, i64 %__v71_lexpr
  call void @_md_transform(i32 %__v10_sha_type, i8* %__v1_md_state, i8* %113)
  br label %114

; <label>:114:                                    ; preds = %111
  %115 = add i64 %__v40_i, 1
  br label %109
...
; <label>:117:                                    ; preds = %120, %77
  %__v41_i = phi i64 [ %78, %77 ], [ %121, %120 ]
  %118 = icmp ult i64 %__v41_i, %81
  br i1 %118, label %119, label %122

; <label>:119:                                    ; preds = %117
  %__v42_block = alloca i8, i64 128
  call void @fact.memset.i8(i8* %__v42_block, i8 0, i64 128)
  %__v43_is_block_a = icmp eq i64 %__v41_i, %__v27_index_a
  %__v44_is_block_b = icmp eq i64 %__v41_i, %__v28_index_b
  br label %123

; <label>:120:                                    ; preds = %180
  %121 = add i64 %__v41_i, 1
  br label %117
...
; <label>:123:                                    ; preds = %127, %119
  %__v45_j = phi i64 [ 0, %119 ], [ %128, %127 ]
  %124 = icmp ult i64 %__v45_j, %__v5_md_block_size
  br i1 %124, label %125, label %129

; <label>:125:                                    ; preds = %123
  %__v46_b = alloca i8
  store i8 0, i8* %__v46_b
  %__v47__k = load i64, i64* %__v30_k
  %126 = icmp ult i64 %__v47__k, %__v20_header_length
  br i1 %126, label %130, label %133

; <label>:127:                                    ; preds = %165
  %128 = add i64 %__v45_j, 1
  br label %123

; <label>:129:                                    ; preds = %123
  call void @_md_transform(i32 %__v10_sha_type, i8* %__v1_md_state, i8* %__v42_block)
  call void @_md_final_raw(i32 %__v10_sha_type, i8* %__v1_md_state, i8* %__v42_block)
  br label %168

; <label>:130:                                    ; preds = %125
  %131 = getelementptr i8, i8* %__v11_header, i64 %__v47__k
  %132 = load i8, i8* %131
  store i8 %132, i8* %__v46_b
  br label %136

; <label>:133:                                    ; preds = %125
  %134 = add i64 %__v58___v12_data_len, %__v20_header_length
  %135 = icmp ult i64 %__v47__k, %134
...
; <label>:136:                                    ; preds = %157, %130
  ...
  %139 = icmp uge i64 %__v45_j, %__v26_c
  %__v48_is_past_c = call i1 @fact.select.asm.i1(i1 %__v43_is_block_a, i1 %139, i1 false)
  %140 = add i64 %__v26_c, 1
  %141 = icmp uge i64 %__v45_j, %140
  %__m1 = call i1 @fact.select.asm.i1(i1 %__v43_is_block_a, i1 %141, i1 false)
  %142 = load i8, i8* %__v46_b
  %143 = call i8 @fact.select.asm.i8(i1 %__v48_is_past_c, i8 -128, i8 %142)
  store i8 %143, i8* %__v46_b
  %144 = and i1 true, %__m1
  %145 = load i8, i8* %__v46_b
  %146 = call i8 @fact.cmov.asm.i8(i1 %144, i8 0, i8 %145)
  store i8 %146, i8* %__v46_b
  %__m2 = xor i1 %__m1, true
  %147 = xor i1 %__v43_is_block_a, true
  %__m3 = call i1 @fact.select.asm.i1(i1 %__v44_is_block_b, i1 %147, i1 false)
  %148 = and i1 true, %__m3
  %149 = load i8, i8* %__v46_b
  %150 = call i8 @fact.cmov.asm.i8(i1 %148, i8 0, i8 %149)
  store i8 %150, i8* %__v46_b
  %__m4 = xor i1 %__m3, true
  %151 = sub i64 %__v5_md_block_size, %__v8_md_length_size
  %152 = icmp uge i64 %__v45_j, %151
  br i1 %152, label %158, label %164

; <label>:153:                                    ; preds = %133
  %__v72_lexpr = sub i64 %__v47__k, %__v20_header_length
  %154 = getelementptr i8, i8* %__v12_data, i64 %__v72_lexpr
  %155 = load i8, i8* %154
  store i8 %155, i8* %__v46_b
  br label %157
...
; <label>:158:                                    ; preds = %136
  ...
  %__v73_lexpr = sub i64 %__v45_j, %159
  %160 = getelementptr i8, i8* %__v34_length_bytes, i64 %__v73_lexpr
  %161 = load i8, i8* %160
  %162 = load i8, i8* %__v46_b
  %163 = call i8 @fact.select.asm.i8(i1 %__v44_is_block_b, i8 %161, i8 %162)
  store i8 %163, i8* %__v46_b
  br label %165
...
; <label>:165:                                    ; preds = %164, %158
  %166 = getelementptr i8, i8* %__v42_block, i64 %__v45_j
  %167 = load i8, i8* %__v46_b
  store i8 %167, i8* %166
  br label %127

; <label>:168:                                    ; preds = %178, %129
  %__v50_j = phi i64 [ 0, %129 ], [ %179, %178 ]
  %169 = icmp ult i64 %__v50_j, %__v4_md_size
  br i1 %169, label %170, label %180

; <label>:170:                                    ; preds = %168
  %171 = getelementptr i8, i8* %__v2_mac_out, i64 %__v50_j
  %172 = getelementptr i8, i8* %__v2_mac_out, i64 %__v50_j
  %173 = load i8, i8* %172
  %174 = getelementptr i8, i8* %__v42_block, i64 %__v50_j
  %175 = load i8, i8* %174
  %176 = call i8 @fact.select.asm.i8(i1 %__v44_is_block_b, i8 %175, i8 0)
  %177 = or i8 %173, %176
  store i8 %177, i8* %171
  br label %178

; <label>:178:                                    ; preds = %170
  %179 = add i64 %__v50_j, 1
  br label %168
