...
# %bb.20:                               # %loop_end345
	...
	cmpl	$56, %r12d
	ja	.LBB0_17
# %bb.21:                               # %loop_end345.branchmerge471_crit_edge
	leaq	524(%rcx), %rdi
	leaq	464(%rcx), %rsi
	leal	73(%rdx), %eax
	movl	%eax, 44(%rbx)          # 4-byte Spill
