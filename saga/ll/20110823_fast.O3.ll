...
entry:
  %_secret___v78_ctx_num = alloca i32, align 4
...
thenbranch:                                       ; preds = %loop_body, %SHA1_Final_public.exit, %elsebranch36, %thenbranch16, %entry
  %_public_merge = phi i32 [ 0, %elsebranch36 ], [ 0, %thenbranch16 ], [ 0, %entry ], [ %_secret_select.i281, %SHA1_Final_public.exit ], [ %_secret_select.i, %loop_body ]
  ret i32 %_public_merge

branchmerge:                                      ; preds = %entry
  %_public_ugtetmp = icmp ugt i16 %_public_tls_ver9, 769
  br i1 %_public_ugtetmp, label %thenbranch16, label %elsebranch36

thenbranch16:                                     ; preds = %branchmerge
  %_public_ulttmp = icmp ult i32 %_public____out_len4, 37
  br i1 %_public_ulttmp, label %thenbranch, label %branchmerge25

branchmerge25:                                    ; preds = %thenbranch16
...
elsebranch36:                                     ; preds = %branchmerge
  ...
  br i1 %_public_ulttmp40, label %thenbranch, label %branchmerge46

branchmerge46:                                    ; preds = %elsebranch36, %branchmerge25
  %_public___v67_inp.0 = phi i64 [ 16, %branchmerge25 ], [ 0, %elsebranch36 ]
  %_public___v68_outp.0 = phi i32 [ 16, %branchmerge25 ], [ 0, %elsebranch36 ]
  %_public___v69__len.0 = phi i32 [ %_public_subtmp, %branchmerge25 ], [ %_public____out_len4, %elsebranch36 ]
  %_secret_source_gep52 = getelementptr inbounds i8, i8* %_secret_arrarg6, i64 %_public___v67_inp.0
  %_public_290 = zext i32 %_public___v68_outp.0 to i64
  %_secret_source_gep61 = getelementptr inbounds i8, i8* %_secret_arrarg3, i64 %_public_290
  ...
  tail call void @aesni_cbc_encrypt(i8* %_secret_source_gep52, i8* %_secret_source_gep61, i64 %_public_zexttmp, %AES_KEY* %_public_structgep, i8* %_secret_arrarg1, i32 0)
  %_public_subtmp67 = add i32 %_public____out_len4, -1
  %_public_291 = sext i32 %_public_subtmp67 to i64
  %_secret_ptr = getelementptr inbounds i8, i8* %_secret_arrarg3, i64 %_public_291
  %_secret_lval68 = load i8, i8* %_secret_ptr, align 1
  %_secret_zexttmp = zext i8 %_secret_lval68 to i32
  %_public_subtmp72 = add i32 %_public___v69__len.0, -21
  %_public_292 = icmp ult i32 %_public_subtmp72, 255
  %_public_terntmp = select i1 %_public_292, i32 %_public_subtmp72, i32 255
  %_secret_ugttmp = icmp ult i32 %_public_terntmp, %_secret_zexttmp
  %_secret_select.i277 = select i1 %_secret_ugttmp, i32 0, i32 1
  %_secret_select.i280 = select i1 %_secret_ugttmp, i32 %_public_terntmp, i32 %_secret_zexttmp
  %_secret_subtmp = sub i32 %_public_subtmp72, %_secret_select.i280
  %_public_subtmp98 = add i64 %_public_plen8, -2
  %_secret_source_gep101 = getelementptr inbounds %EVP_AES_HMAC_SHA1, %EVP_AES_HMAC_SHA1* %key, i64 0, i32 5, i64 %_public_subtmp98
  ...
  store i8 %_secret_ucast.i, i8* %_secret_source_gep101, align 1
  %_secret_ptr4.i = getelementptr inbounds i8, i8* %_secret_source_gep101, i64 1
  %_secret_ucast6.i = trunc i16 %_secret_ucast to i8
  store i8 %_secret_ucast6.i, i8* %_secret_ptr4.i, align 1
  store i32 0, i32* %_secret___v78_ctx_num, align 4
  %_secret___v79_pmac = alloca [20 x i8], align 32
  %_public_structgep104 = getelementptr inbounds %EVP_AES_HMAC_SHA1, %EVP_AES_HMAC_SHA1* %key, i64 0, i32 3
  %_public_structgep105 = getelementptr inbounds %EVP_AES_HMAC_SHA1, %EVP_AES_HMAC_SHA1* %key, i64 0, i32 1
  %_secret_cast.i = bitcast %SHA_CTX* %_public_structgep104 to i8*
  %_secret_cast1.i = bitcast %SHA_CTX* %_public_structgep105 to i8*
  ...
  %_secret_source_gep113 = getelementptr inbounds %EVP_AES_HMAC_SHA1, %EVP_AES_HMAC_SHA1* %key, i64 0, i32 5, i64 0
  tail call fastcc void @SHA1_Update_public(%SHA_CTX* nonnull %_public_structgep104, i8* nonnull %_secret_source_gep113, i32 %_public_trunctmp)
  %_public_ugtetmp121 = icmp ugt i32 %_public___v69__len.0, 339
  %_public_structgep133 = getelementptr inbounds %EVP_AES_HMAC_SHA1, %EVP_AES_HMAC_SHA1* %key, i64 0, i32 3, i32 4
  %_public_lval134 = load i32, i32* %_public_structgep133, align 4
  %_public_andtmp276 = add i32 %_public___v69__len.0, -276
  %_public_subtmp135 = and i32 %_public_andtmp276, -64
  %_public_addtmp136 = sub i32 %_public_subtmp135, %_public_lval134
  %_public_terntmp137 = select i1 %_public_ugtetmp121, i32 %_public_addtmp136, i32 0
  %_public_ugttmp139 = icmp eq i32 %_public_terntmp137, 0
  br i1 %_public_ugttmp139, label %branchmerge155, label %thenbranch141

thenbranch141:                                    ; preds = %branchmerge46
  tail call fastcc void @SHA1_Update_public(%SHA_CTX* nonnull %_public_structgep104, i8* %_secret_source_gep61, i32 %_public_terntmp137)
  br label %branchmerge155

branchmerge155:                                   ; preds = %branchmerge46, %thenbranch141
  %_public_subtmp158 = sub i32 %_public___v69__len.0, %_public_terntmp137
  %_public_addtmp168 = add i32 %_public_terntmp137, %_public___v68_outp.0
  %_public_288 = sext i32 %_public_addtmp168 to i64
  %_secret_source_gep170 = getelementptr inbounds i8, i8* %_secret_arrarg3, i64 %_public_288
  %_secret_subtmp176 = sub i32 %_secret_subtmp, %_public_terntmp137
  call fastcc void @SHA1_Update_secret(%SHA_CTX* nonnull %_public_structgep104, i32* nonnull %_secret___v78_ctx_num, i8* %_secret_source_gep170, i32 %_public_subtmp158, i32 %_secret_subtmp176)
  %_secret_arrtoptr = getelementptr inbounds [20 x i8], [20 x i8]* %_secret___v79_pmac, i64 0, i64 0
  %_secret_lval178 = load i32, i32* %_secret___v78_ctx_num, align 4
  call fastcc void @SHA1_Final_secret(i8* nonnull %_secret_arrtoptr, %SHA_CTX* nonnull %_public_structgep104, i32 %_secret_lval178)
  %_public_structgep180 = getelementptr inbounds %EVP_AES_HMAC_SHA1, %EVP_AES_HMAC_SHA1* %key, i64 0, i32 2
  %_secret_cast.i282 = bitcast %SHA_CTX* %_public_structgep104 to i8*
  %_secret_cast1.i283 = bitcast %SHA_CTX* %_public_structgep180 to i8*
  tail call void @llvm.memcpy.p0i8.p0i8.i32(i8* %_secret_cast.i282, i8* %_secret_cast1.i283, i32 96, i32 4, i1 false) #2
  call fastcc void @SHA1_Update_public(%SHA_CTX* nonnull %_public_structgep104, i8* nonnull %_secret_arrtoptr, i32 20)
  %_public_structgep.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 4
  %_public_lval.i = load i32, i32* %_public_structgep.i, align 4
  %_public_289 = sext i32 %_public_lval.i to i64
  %_secret_ptr.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 3, i64 %_public_289
...
entry.branchmerge_crit_edge.i:                    ; preds = %branchmerge155
  %_public_.pre.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 3, i64 0
  br label %SHA1_Final_public.exit

thenbranch.i:                                     ; preds = %branchmerge155
  %_public_subtmp.i = sub i32 63, %_public_lval.i
  %_public_287 = sext i32 %_public_addtmp.i to i64
  %_secret_source_gep11.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 3, i64 %_public_287
  call fastcc void @_memzero(i8* nonnull %_secret_source_gep11.i, i32 %_public_subtmp.i)
  %_secret_arrtoptr.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 3, i64 0
  call void @sha1_block_data_order(%SHA_CTX* nonnull %_public_structgep104, i8* nonnull %_secret_arrtoptr.i, i32 1)
  br label %SHA1_Final_public.exit
...
SHA1_Final_public.exit:                           ; preds = %entry.branchmerge_crit_edge.i, %thenbranch.i
  ...
  %_public_286 = sext i32 %_public___v32_num.0.i to i64
  %_secret_source_gep24.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 3, i64 %_public_286
  call fastcc void @_memzero(i8* nonnull %_secret_source_gep24.i, i32 %_public_subtmp16.i)
  %_secret_source_gep32.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 3, i64 56
  %_secret_structgep34.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 2
  ...
  %_secret_ucast16.i.i = trunc i32 %_secret_lval.i to i8
  store i8 %_secret_ucast16.i.i, i8* %_secret_ptr14.i.i, align 1
  %_secret_source_gep40.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 3, i64 60
  %_secret_structgep42.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 1
  ...
  call void @sha1_block_data_order(%SHA_CTX* nonnull %_public_structgep104, i8* nonnull %_secret_arrtoptr46.pre-phi.i, i32 1)
  store i32 0, i32* %_public_structgep.i, align 4
  call fastcc void @_memzero(i8* nonnull %_secret_arrtoptr46.pre-phi.i, i32 64)
  %_secret_ptr.i.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 0, i64 0
  ...
  %_secret_ptr.1.i.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 0, i64 1
  ...
  %_secret_ptr.2.i.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 0, i64 2
  ...
  %_secret_ptr.3.i.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 0, i64 3
  ...
  %_secret_ptr.4.i.i = getelementptr inbounds %SHA_CTX, %SHA_CTX* %_public_structgep104, i64 0, i32 0, i64 4
  ...
  %_public_ulttmp188 = icmp ult i32 %_public___v69__len.0, 276
  %_public_terntmp194 = select i1 %_public_ulttmp188, i32 0, i32 %_public_andtmp276
  %_secret_addtmp197 = add i32 %_secret_subtmp, %_public___v68_outp.0
  %_secret_addtmp199 = add i32 %_secret_addtmp197, 20
  %_secret_ugttmp201 = icmp ugt i32 %_secret_addtmp199, %_public___v69__len.0
  %_secret_select.i281 = select i1 %_secret_ugttmp201, i32 0, i32 %_secret_select.i277
  %_public_addtmp213 = add i32 %_public_terntmp194, %_public___v68_outp.0
  %_public_ulttmp216273 = icmp ult i32 %_public_addtmp213, %_public___v69__len.0
  br i1 %_public_ulttmp216273, label %loop_body.preheader, label %thenbranch

loop_body.preheader:                              ; preds = %SHA1_Final_public.exit
  br label %loop_body

loop_body:                                        ; preds = %loop_body.preheader, %loop_body
  %_public___v88_i.0275 = phi i32 [ %_public_addtmp270, %loop_body ], [ %_public_addtmp213, %loop_body.preheader ]
  %_secret___v66_ret.0274 = phi i32 [ %_secret_select.i, %loop_body ], [ %_secret_select.i281, %loop_body.preheader ]
  %_secret_ugtetmp = icmp uge i32 %_public___v88_i.0275, %_secret_addtmp197
  %_secret_ulttmp = icmp ult i32 %_public___v88_i.0275, %_secret_addtmp199
  %_secret_zext.i = zext i1 %_secret_ulttmp to i32
  %_secret_asm.i278 = call i32 asm "testb $1, $1; mov $3, $0; cmovnz $2, $0", "=&r,r,r,r,~{flags}"(i1 %_secret_ugtetmp, i32 %_secret_zext.i, i32 0) #2
  %_secret_ = and i32 %_secret_asm.i278, 1
  %_secret_trunc.i279 = icmp ne i32 %_secret_, 0
  %_secret_lnottmp235 = xor i1 %_secret_ugtetmp, true
  %_secret_zext1.i = zext i1 %_secret_trunc.i279 to i32
  %_secret_asm.i = call i32 asm "testb $1, $1; mov $3, $0; cmovnz $2, $0", "=&r,r,r,r,~{flags}"(i1 %_secret_lnottmp235, i32 0, i32 %_secret_zext1.i) #2
  %_secret_284 = and i32 %_secret_asm.i, 1
  %_secret_trunc.i = icmp ne i32 %_secret_284, 0
  %_secret_subtmp248 = sub i32 %_public___v88_i.0275, %_secret_addtmp197
  %_public_ = sext i32 %_public___v88_i.0275 to i64
  %_secret_ptr251 = getelementptr inbounds i8, i8* %_secret_arrarg3, i64 %_public_
  %_secret_lval252 = load i8, i8* %_secret_ptr251, align 1
  %_secret_285 = sext i32 %_secret_subtmp248 to i64
  %_secret_ptr254 = getelementptr inbounds [20 x i8], [20 x i8]* %_secret___v79_pmac, i64 0, i64 %_secret_285
  %_secret_lval255 = load i8, i8* %_secret_ptr254, align 1
  %_secret_neqtmp = icmp ne i8 %_secret_lval252, %_secret_lval255
  %_secret_landtmp261 = and i1 %_secret_trunc.i, %_secret_neqtmp
  %_secret_select.i = select i1 %_secret_landtmp261, i32 0, i32 %_secret___v66_ret.0274
  %_public_addtmp270 = add i32 %_public___v88_i.0275, 1
  %_public_ulttmp216 = icmp ult i32 %_public_addtmp270, %_public___v69__len.0
  br i1 %_public_ulttmp216, label %loop_body, label %thenbranch
}
