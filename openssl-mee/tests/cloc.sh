...
Definition | FaCT | C
--- | --- | ---
(full implementation) | [20170717_latest.fact](/openssl-mee/20170717_latest.fact) | [crypto/evp/e_aes_cbc_hmac_sha1.c:${cstart}-${cend}](/openssl-mee/tests/openssl-fact-ugly/crypto/evp/e_aes_cbc_hmac_sha1.c#L${cstart}-L${cend})
EOF
...
echo -e "openssl-mee\t$cloc\t$factloc\t$na\t$nd\t$ne"
