...
print('openssl-mee 256 MB', (median(fact_256m) / median(c_256m) - 1) * 100, sep='\t')
print('openssl-mee 1 GB', (median(fact_1g) / median(c_1g) - 1) * 100, sep='\t')
print('openssl-mee 4 GB', (median(fact_4g) / median(c_4g) - 1) * 100, sep='\t')
print()
